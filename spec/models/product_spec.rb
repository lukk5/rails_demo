...
RSpec.describe Product, type: :model do
    describe 'validations' do
        ...
        it 'is invalid without a price' do
            ...
            product.valid?
            expect(product.errors[:price]).to include("must be provided")
        end
        ...
        it 'is invalid without an image URL' do
            ...
            product.valid?
            expect(product.errors[:image_url]).to include("must be provided")
        end
        ...
        it 'is invalid with an invalid image URL format' do
            product = Product.new(image_url: 'invalid_url')
            product.valid?
